...
#from models1.se_densenet_transition import densenet121
#from models1.se_densenet_block import densenet121
from models1.se_densenet_full import densenet121
...
if __name__ == '__main__':
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), "E:\python_project\Test12_ConvNeXt"))  # get data root path
    ...
    model_weight_path = "../AM_SEdensenet121_full八分类.pth"
