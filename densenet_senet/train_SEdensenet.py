...
from models1.se_densenet_transition import densenet121, load_state_dict
...
def main(args):
    ...
    if os.path.exists("./best_weights4") is False:
        os.makedirs("./best_weights4")
  ...
  #  if os.path.exists("./best_weights") is False:
    ...
    train_accurate = []
    val_accurate = []
    save_path = './SEdensenet121_transition八分类.pth'
    print(model.buffers)
    ...
    plt.legend()
    # 保存损失图
    plt.savefig('./loss_curve_SEDensenet_transition八分类.png')
    # 显示损失图
    plt.show()
    ...
    plt.plot(train_accurate, label="val_accurate")
    plt.plot(val_accurate, label="train_accurate")
    #   plt.plot(V_losses, label="V")
    plt.xlabel("Epoches")
    plt.ylabel("accurate")
    plt.legend()
    # 保存损失图
    plt.savefig('./train_val_accurate_SEDensenet_transition八分类.png')
    # 显示损失图
    plt.show()
