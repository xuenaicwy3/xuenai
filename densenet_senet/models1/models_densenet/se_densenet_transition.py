...
from models1.new_senet import SELayer
class _DenseLayer(nn.Module):
    def __init__(self,
        ...
        self.add_module("selayer", SELayer(channel=input_c))
...
def densenet121(**kwargs: Any) -> SEDenseNet:
    # Top-1 error: 25.35%
    # 'densenet121': 'https://download.pytorch.org/models/densenet121-a639ec97.pth'
    return SEDenseNet(growth_rate=32,
                    block_config=(6, 12, 24, 16),
                    num_init_features=64,
                    **kwargs)


def densenet169(**kwargs: Any) -> SEDenseNet:
    # Top-1 error: 24.00%
...
def densenet201(**kwargs: Any) -> SEDenseNet:
    # Top-1 error: 22.80%
...
def densenet161(**kwargs: Any) -> SEDenseNet:
    # Top-1 error: 22.35%
    # 'densenet161': 'https://download.pytorch.org/models/densenet161-8d451a50.pth'
    return SEDenseNet(growth_rate=48,
