...
#from model import densenet201, load_state_dict
...
def main(args):
    ...
    train_accurate = []
    val_accurate = []
    save_path = './SEdensenet121_full_camera_test_epochs=30.pth'
    print(model.buffers)
    for epoch in range(args.epochs):
        ...
        if round(acc, 3) > best_acc:
            ...
            torch.save(model.state_dict(), "./best_weights/model-{}.pth".format(epoch))
    ...
    # 打印最佳acc、f1
    print('Best_ACC: %.4f\t' % (
        best_acc))  # se_densenet_tranition: 0.9970
    ...
    plt.legend()
    # 保存损失图
    plt.savefig('./loss_curve_SEDensenet_full八分类.png')
    # 显示损失图
    plt.show()
    ...
    plt.legend()
    # 保存损失图
    plt.savefig('./train_val_accurate_SEDensenet_full八分类.png')
    # 显示损失图
    plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="/home/amax/sdb1/wanglu/Test12_ConvNext/data_set/breast_data/breast_photos_X40")

    # densenet121 官方权重下载地址
    # https://download.pytorch.org/models/densenet121-a639ec97.pth
    parser.add_argument('--weights', type=str, default='SEdensenet121_full_epochs=100.pth',
