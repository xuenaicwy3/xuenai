...
if __name__ == '__main__':
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), "./data18"))  # get data root path
    ...
    test_dataset = datasets.ImageFolder(root=os.path.join(image_path, "test_dir"),
    ...
    validate_loader = torch.utils.data.DataLoader(test_dataset,
                                                  ...
                                                  num_workers=1)
    net = create_model(num_classes=7)
    #print(net)
    # load pretrain weights
    model_weight_path = "./best_weights/se_simam_convnext_best_model/model-219.pth"
