...
#from MobileNetV2model import MobileNetV2
...
accessKeyId = 'LTAI5tJVNHNxk5rvP8taUmea'
accessSecret = 'Kbc15HgRhQyiC42pvd0uVIVilNG3tn'
region = 'cn-shenzhen'
...
def get_prediction(image_bytes):
    try:
        ...
        template = "诊断结果:{:<15} probability:{:.3f}"
        #template = "class:{} probability:{:.3f}"
